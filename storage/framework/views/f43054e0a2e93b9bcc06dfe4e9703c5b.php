<div class="page-main-header">
  <div class="main-header-right">
    <div class="main-header-left text-center">
      ...
      <img class="img-fluid" src="<?php echo e(asset('/assets/images/logo/logoMobilink.png')); ?>" width="170px" alt="">
      </div>
    </div>
    ...
    <div class="nav-right col pull-right right-menu">
      <ul class="nav-menus">
            ...
            <div class="form-group">
              <div class="Typeahead Typeahead--twitterUsers">
                <div class="u-posRelative">
                  <input class="Typeahead-input form-control-plaintext" id="demo-input" type="text" name="q" placeholder="Cari...">
        ...
        <li class="onhover-dropdown"><img class="img-fluid img-shadow-warning" src="<?php echo e(asset('/assets/images/dashboard/bookmark.png')); ?>" alt="">
        ...
        <li class="onhover-dropdown"><img class="img-fluid img-shadow-secondary" src="<?php echo e(asset('/assets/images/dashboard/like.png')); ?>" alt="">
        ...
        <li class="onhover-dropdown"><img class="img-fluid img-shadow-warning" src="<?php echo e(asset('/assets/images/dashboard/notification.png')); ?>" alt="">
        ...
        <li class="onhover-dropdown"> <span style="width: 60px;" class="media user-header"><img class="img-fluid"  src="<?php echo e(asset('/assets/images/dashboard/user1.png')); ?>" alt=""></span>
          <ul class="onhover-show-div profile-dropdown">
            ...
            <li><i data-feather="settings"> </i><a href="<?php echo e(route('login.index')); ?>">Keluar</a></li>
          </ul>
        </li>
      </ul>
...
</div><?php /**PATH C:\xampp\htdocs\webS4\resources\views/layouts/simple/header.blade.php ENDPATH**/ ?>