...
<div class="error-wrapper">
   <div class="container">
      ...
      <div><a class="btn btn-danger-gradien btn-lg" href="<?php echo e(asset('')); ?>">BACK TO HOME PAGE</a></div>
   </div>
</div>
<!-- error-404 end      -->
<?php $__env->stopSection(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\poco\resources\views/errors/404.blade.php ENDPATH**/ ?>