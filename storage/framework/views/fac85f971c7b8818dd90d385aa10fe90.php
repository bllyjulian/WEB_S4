							...
							<div class="col-xl-12">
								<div class="card event-detail-bx overflow-hidden">
									<div class="card-media">
										<img src="<?php echo e(asset('htd/images/gunungdashboard.png')); ?>" alt="" class="w-100">
									</div>
									<div class="card-body">
										<div class="d-flex flex-wrap align-items-center mb-4">
											<h2 class="text-black col-xl-6 p-0 col-xxl-12 mr-auto title mb-3">Informasi dan Aktivitas Pendakian Gunung Ranti.</h2>
											<div class="d-flex align-items-center">
												<a href="" class="btn btn-primary light mr-3"><img src="<?php echo e(asset('htd/icons/aktifitaspendaki.png')); ?>" alt="" width="30px">Aktifitas Pendaki</a>
												<a href="javascript:void(0)" class="share-icon mr-3 d-flex align-items-center justify-content-center">
												...
												<div class="dropdown">
													<div class="share-icon d-flex align-items-center justify-content-center" role="button" data-toggle="dropdown" aria-expanded="false">
														<svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<div class="row">
											<div class="col-lg-3 col-md-6 col-xxl-6 mb-3">
												<div class="media bg-light p-3 rounded align-items-center">	
													...
													<div class="media-body">
														<span class="fs-12 d-block mb-1">Pendapatan</span>
														<span class="fs-16 text-black">Rp. 423.943</span>
													</div>
												</div>
											</div>
											...
											<div class="col-lg-5 col-md-12 col-xxl-12 mb-3">
												<div class="media bg-light p-3 rounded align-items-center">	
													...
													<div class="media-body">
														<span class="fs-12 d-block mb-1">Lokasi</span>
														<span class="fs-16 text-black">Kabupaten Banyuwangi, Provinsi Jawa Timur</span>
													</div>
												</div>
											</div>
										</div>
										<h4 class="fs-20 text-black font-w600">Deskripsi</h4>
										<p class="fs-14 mb-0">Gunung Ranti adalah sebuah gunung yang terletak di Jawa Timur, Indonesia, tepatnya di wilayah Kabupaten Bondowoso, dekat dengan perbatasan dengan Kabupaten Banyuwangi. Gunung ini memiliki ketinggian sekitar 1.851 meter di atas permukaan laut (mdpl) dan terletak di kawasan yang dikelilingi oleh hutan tropis yang masih alami.
                                        <br>
                                        Pendakian Gunung Ranti menawarkan pengalaman yang menarik bagi para pendaki dengan beragam jalur pendakian yang dapat dipilih, tergantung pada tingkat kesulitan dan preferensi pendaki. Selain itu, gunung ini juga dikenal dengan keindahan alamnya yang mempesona, termasuk air terjun dan pemandangan yang menakjubkan dari puncaknya.
                                        <br>
                                        Gunung Ranti sering kali menjadi pilihan para pendaki yang ingin mengeksplorasi keindahan alam Jawa Timur sambil menikmati tantangan pendakian yang disajikan. Hal ini membuatnya menjadi destinasi yang populer di kalangan pendaki lokal maupun internasional yang mencari petualangan dan keindahan alam yang masih alami.</p>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-xl-12 col-sm-6">
								...
								<div class="col-xl-12">
										<div class="card">
											<div class="card-body">
												<div class="d-flex justify-content-between align-items-center gap-100">
													<div>
														<p class="fs-14 mb-1">Cuaca Hari ini</p>
														<span class="fs-35 text-black font-w600">23°C
														...
														<p class="fs-14 mb-1">Akan terjadi hujan beberapa jam lagi!</p>
													</div>
													<div class="d-block">
														...
														<img src="<?php echo e(asset('htd/icons/cuaca.png')); ?>" alt="" width="90px">														
													</div>
												</div>
												<button type="button" class="btn btn-primary mt-3" id="btnpop">Peringati Pendaki!</button>
											</div>
										</div>
									</div>
									<div class="col-xl-12">
										<div class="card">
											<div class="card-body">
												<div class="d-flex align-items-end">
													<div>
														<p class="fs-14 mb-1">Tiket Terjual</p>
									...
									<div class="col-xl-12">
										<div class="card">
											<div class="card-header align-items-start pb-0 border-0">	
												<div>
													<h4 class="fs-16 mb-0 text-black font-w600">Meningkat 25%</h4>
													<span class="fs-12">Perbandingan</span>
												</div>
							...
							<div class="col-xl-12 col-sm-6">
								<div class="card">
									<div class="card-header border-0 pb-0">
										<h4 class="fs-20 text-black">Total Pendaki</h4>
									</div>
									<div class="card-body pt-3">
										...
										<div class="d-flex justify-content-between align-items-center">
											<div>
												<p class="fs-28 text-black font-w600 mb-1">2 Pendaki</p>
												<span>Memesan Tiket</span>
											</div>
...
<script>
    $(document).ready(function() {
        $('#btnpop').click(function (e) {
            Swal.fire({
                title: 'Peringati para pendaki!',
                text: "Perkiraan cuaca menunjukkan hujan akan turun dalam beberapa jam ke depan.",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                confirmButtonText: 'Peringati',
                cancelButtonText: 'Batal'
            }).then((result) => {
                if (result.isConfirmed) {
                    Swal.fire(
                        'Berhasil!',
                        'Data cuaca telah dikirim ke para pendaki!',
                        'success'
                    ).then(() => {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layoutshtd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\webS4\resources\views/htdgemastik/dashboard/index.blade.php ENDPATH**/ ?>