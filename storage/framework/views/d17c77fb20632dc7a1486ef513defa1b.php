  ...
  <body class="<?php if(url()->current() == route('button-builder')): ?>  button-builder <?php endif; ?>">
    ...
    <div class="page-wrapper">
      ...
      <div class="page-body-wrapper">
        <!-- Page Sidebar Start-->
        <?php echo $__env->make('layouts.simple.sidebar_mobilink', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- Page Sidebar Ends-->
        <!-- Right sidebar Start-->
...
<?php /**PATH C:\xampp\htdocs\webS4\resources\views/layouts/simple/master_mobilink.blade.php ENDPATH**/ ?>