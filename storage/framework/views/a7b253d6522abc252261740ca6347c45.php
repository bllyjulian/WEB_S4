        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="<?php echo e(asset('htd/images/htd.png')); ?>" alt="">
                <img class="logo-compact" src="<?php echo e(asset('htd/images/htd-text.png')); ?>" alt="">
                <img class="brand-title" src="<?php echo e(asset('htd/images/htd-text.png')); ?>" alt="">
            </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
                            <div class="dashboard_bar">
                                <?php echo $__env->yieldContent('header-title', 'Default Title'); ?>
                            </div>
                        </div>
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    <img src="<?php echo e(asset('/htd/icons/tes.jpg')); ?>" width="20" alt=""/>
                                </a>
        ...
        ***********************************--><?php /**PATH C:\xampp\htdocs\webS4\resources\views/layoutshtd/header.blade.php ENDPATH**/ ?>