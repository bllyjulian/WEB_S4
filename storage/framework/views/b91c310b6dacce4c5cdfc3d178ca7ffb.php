...
<html lang="en">
  <head>
    ...
    <title>Mobilink - <?php echo $__env->yieldContent('title'); ?></title>
  ...
  <body class="<?php if(url()->current() == route('button-builder')): ?>  button-builder <?php endif; ?>">
    ...
    <div class="page-wrapper">
      ...
      <div class="page-body-wrapper">
        <!-- Page Sidebar Start-->
        <?php echo $__env->make('layouts.simple.sidebar_mitra', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- Page Sidebar Ends-->
        <!-- Right sidebar Start-->
              ...
              <div class="page-header">
                 <div class="row">
                    <div class="col-lg-6 main-header">
                        ...
                        <h6 class="mb-0">MOBILINK</h6>
                    </div>
                    <div class="col-lg-6 breadcrumb-right">
                       <ol class="breadcrumb">
                          <li class="breadcrumb-item"><a href="<?php echo e(asset('')); ?>"><i class="pe-7s-home"></i></a></li>
...
<?php /**PATH C:\xampp\htdocs\webS4\resources\views/layouts/simple/master_mitra.blade.php ENDPATH**/ ?>