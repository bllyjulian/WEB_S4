                  ...
                  <div class="row">
                     ...
                     <div class="form-group">
                        ...
                        <div class="form-group">
                           ...
                           <input style="border-radius:5px;" class="form-control" type="text" id="harga_sewa_perhari" name="harga_sewa_perhari" value="<?php echo e($mobil->harga_sewa_perhari); ?>" required>
                        </div>
                     </div>
                  </div>
