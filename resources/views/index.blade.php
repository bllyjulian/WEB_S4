        ...
        @include('LP/layouts.navbar')
            <div class="header-content">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <img src="{{ asset ('frontend/assets/images/app_1.png')}}" alt="app" width="388px" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 mb-5 mb-md-0">
                    <img src="{{ asset ('frontend/assets/images/app_2.png')}}" alt="special offers" class="img-fluid" width="492px">
                </div>
                <div class="col-md-6">
