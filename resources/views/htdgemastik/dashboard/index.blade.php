							...
							<div class="col-xl-12">
								<div class="card event-detail-bx overflow-hidden">
									<div class="card-media">
										<img src="{{ asset('htd/images/gunungdashboard.png')}}" alt="" class="w-100">
									</div>
									<div class="card-body">
										<div class="d-flex flex-wrap align-items-center mb-4">
											...
											<div class="d-flex align-items-center">
												<a href="" class="btn btn-primary light mr-3"><img src="{{ asset('htd/icons/aktifitaspendaki.png')}}" alt="" width="30px">Aktifitas Pendaki</a>
											...
											<div class="card-body">
												<div class="d-flex justify-content-between align-items-center gap-100">
													...
													<div class="d-block">
														...
														<img src="{{ asset('htd/icons/cuaca.png')}}" alt="" width="90px">														
													</div>
												</div>
