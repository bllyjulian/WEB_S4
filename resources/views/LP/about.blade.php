                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-md-3 mb-5">
                        <div class="team-member-card">
                            <img src="{{ asset('frontend/assets/images/user/user_1.png')}}" alt="Cardarion Hart" class="team-member-avatar">
                    ...
                    <div class="col-md-3 mb-5">
                        <div class="team-member-card">
                            <img src="{{ asset('frontend/assets/images/user/user_2.png')}}" alt="Gauthier Drewitt" class="team-member-avatar">
                    ...
                    <div class="col-md-3 mb-5">
                        <div class="team-member-card">
                            <img src="{{ asset('frontend/assets/images/user/user_3.png')}}" alt="Labeeba Al Amer" class="team-member-avatar">
