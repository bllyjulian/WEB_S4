            ...
            <section class="foi-page-section">
                <div class="row mb-5">
                    <div class="col-md-4 foi-feature">
                        <img src="{{ asset('frontend/assets/images/icon_1.png')}}" alt="icon" class="feature-icon">
                    ...
                    <div class="col-md-4 foi-feature">
                        <img src="{{ asset('frontend/assets/images/icon_2.png')}}" alt="icon" class="feature-icon">
                        <h5 class="feature-title">Online Payment</h5>
                        <p class="feature-content">Lorem ipsum dolor sit amt, consectet adop adipisicing elit, sed do eiusmod teporara incididunt ugt labore.</p>
                        <a href="#!" class="feature-link">Find out More</a>
                    </div>
                    <div class="col-md-4 foi-feature">
                        <img src="{{ asset('frontend/assets/images/icon_3.png')}}" alt="icon" class="feature-icon">
                        <h5 class="feature-title">Online Payment</h5>
                        <p class="feature-content">Lorem ipsum dolor sit amt, consectet adop adipisicing elit, sed do eiusmod teporara incididunt ugt labore.</p>
                        <a href="#!" class="feature-link">Find out More</a>
                    </div>
            ...
            <section class="foi-page-section">
                <div class="row">
                    <div class="col-md-6 mb-5 mb-md-0">
                        <img src="{{ asset('frontend/assets/images/img_3.png')}}" alt="faq" class="img-fluid" width="424px">
                    </div>
                    <div class="col-md-6">
