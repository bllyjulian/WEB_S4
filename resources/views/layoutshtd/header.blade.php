        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="{{ asset('htd/images/htd.png')}}" alt="">
                <img class="logo-compact" src="{{ asset('htd/images/htd-text.png')}}" alt="">
                <img class="brand-title" src="{{ asset('htd/images/htd-text.png')}}" alt="">
            </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        <div class="header-left">
                            <div class="dashboard_bar">
                                @yield('header-title', 'Default Title')
                            </div>
                        </div>
                        <ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown notification_dropdown">
                                ...
                                <div class="dropdown-menu rounded dropdown-menu-right">
                                    ...
                                    <li>
                                        <div class="timeline-panel">
                                            <div class="media mr-2">
                                                <img alt="image" width="50" src="{{ asset('/htd/icons/notip.png')}}">
                                            </div>
                                            <div class="media-body">
                                                <h6 class="mb-1">{{ $lap->pendaki->nama }} - {{ $lap->jenis_laporan }}</h6>
                                                <small class="d-block">{{ \Carbon\Carbon::parse($lap->timestamp)->locale('id')->diffForHumans() }}</small>
                                            </div>
                                        </div>
                                    </li>
                                    @endforeach
                                    ...
                                    <a class="all-notification" href="{{route ('laporan')}}">Lihat semua notifikasi <i class="ti-arrow-right"></i></a>
                                </div>
                            </li>
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    <img src="{{ asset('/htd/icons/tes.jpg')}}" width="20" alt=""/>
                                </a>
