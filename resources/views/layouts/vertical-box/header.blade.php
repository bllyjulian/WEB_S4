<div class="page-main-header">
  <div class="main-header-right">
     <div class="main-header-left text-center">
        <div class="logo-wrapper"><a href="{{asset('/')}}"><img src="{{asset ('assets/images/logo/logo.png')}}" alt=""></a></div>
     </div>
     ...
     <div class="nav-right col pull-right right-menu">
        <ul class="nav-menus">
           ...
           <li class="onhover-dropdown">
              <img class="img-fluid img-shadow-secondary" src="{{asset ('assets/images/dashboard/like.pn')}}g" alt="">
