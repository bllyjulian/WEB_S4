<div class="iconsidebar-menu">
   <div class="sidebar">
      <ul class="iconMenu-bar custom-scrollbar w-100">
         ...
         <li>
            <a class="bar-icons" href="{{route('admin.detailsewa')}}"><i class="icon-map-alt"></i><span>Detail Sewa</span></a>
         </li>
         <li>
            <span class="badge badge-pill badge-danger">8</span><a class="bar-icons" href="{{route('admin.orderan')}}"><i class="pe-7s-diamond"></i><span>Orderan</span></a>
